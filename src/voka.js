class Voka {
    ...
    _toggleBodyScroll = function (isDisable) {
        if (isDisable) {
    ...
    open = function () {
        if (this._backdrop?.classList.contains("voka--show"))
    ...
    close = function (destroy = this.opt.destroyOnClose) {
